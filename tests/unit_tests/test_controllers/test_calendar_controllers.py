...
def test_fetch_calendar_data_user_lookup_fail(test_client_with_db, generate_test_token):
    with mock.patch('controllers.calendar_controller.CalendarData.get_user_calendars_service', new_callable=AsyncMock) as mock_get_user_calendars:
...
def test_fetch_calendar_data_user_lookup_succeeds(test_client_with_db, generate_test_token):
    with mock.patch('controllers.calendar_controller.CalendarData.get_user_calendars_service', new_callable=AsyncMock) as mock_get_user_calendars, \
         mock.patch('controllers.calendar_controller.CalendarData.fetch_all_user_calendars_service', new_callable=AsyncMock) as mock_populate_user_calendars:
...
def test_fetch_calendar_data_calendar_population_fail(test_client_with_db, generate_test_token):
    with mock.patch('controllers.calendar_controller.CalendarData.fetch_all_user_calendars_service', new_callable=AsyncMock) as mock_populate_user_calendars:
